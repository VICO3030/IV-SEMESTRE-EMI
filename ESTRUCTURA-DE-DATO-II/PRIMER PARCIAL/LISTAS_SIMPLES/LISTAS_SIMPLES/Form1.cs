    ...
    public partial class FRM_lista : Form
    {
       ...
       //vamos a volver statico
        ...
        private void Btn_edad_eleminar_Click(object sender, EventArgs e)
        {
            ...
            if (Estatica.Lista.EleminarEdad(ed) == 0)
            {
                MessageBox.Show  ("No existe ninguna persona con esa Edad ");
            }
            else
            {
                MessageBox.Show("Se elemino de edad : " + ed + "  cantidad : " + Estatica.Lista.EleminarEdad(ed));
            }

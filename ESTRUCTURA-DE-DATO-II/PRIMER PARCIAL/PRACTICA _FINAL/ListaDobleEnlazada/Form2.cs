...
namespace ListaDobleEnlazada
{
    public partial class frm_carreras : Form
    {
        ...
        {
            Estatica.carreras.agregar(int.Parse(txt_nBici.Text), float.Parse(txt_tiempo.Text), txt_lugar.Text, DateTime.Parse(txt_fecha.Text));
            dgv_carreras.Rows.Add(punt.get_nomCic(),txt_nBici.Text,txt_lugar.Text,txt_tiempo.Text,txt_fecha.Text);

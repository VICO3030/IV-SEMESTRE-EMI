    ...
    public partial class Frm_Busqueda : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
          NodoCiclista punt;
           string nomactual = txt_nombusqueda.Text;
             punt = Estatica.ciclistas.existe_nom(txt_nombusqueda.Text);
            //  Estatica.ciclistas.Eleminar(punt);
            Estatica.ciclistas.eleminar02(punt.get_nomCic());
            MessageBox.Show("Se elemino ciclista !!");
        }

        private void lbl_nro_actual_Click(object sender, EventArgs e)
        {

...
public class Lista <T> implements Iterable<T> , Serializable {//interfaz como cuando haciamos en c++ de declarar  , ahora lo que vamos hacer es pvolver familiar T, como una  herencia Iterables
